...
class TestSummarizeAssay(unittest.TestCase): #TestBase):
    ...
    def testSummarizeAssay(self):
        ...
        expected_pref_refgene=os.path.join(testfiles, "expected-pref_refgene_summary.txt")
        expected_other_refgene=os.path.join(testfiles, "expected-other_refgene_summary.txt")
